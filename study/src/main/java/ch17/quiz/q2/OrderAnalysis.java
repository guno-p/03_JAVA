...
public class OrderAnalysis {
    public static void main(String[] args) {
        ...
        List<Integer> answer1 = orders.stream()
                ...
                .boxed()
                .toList();
        System.out.println("결과 1 : " + answer1);
        ...
        System.out.println("결과 2 : " + answer2);
        ...
        String answer3 = orders.stream()
                ...
                .orElse("없음");
        System.out.println("결과 3 : " + answer3);

        // 4. 2023년 5월 이후의 주문에서 구매된 모든 제품의 이름을 중복 없이 반환하기
        // 결과: [자바 책, 태블릿, 노트북, 스마트폰, 충전기]
        List<String> answer4 = orders.stream()
                .filter(order -> order.getOrderDate().isAfter(LocalDate.of(2023, 04, 30)))
                .flatMap(order -> order.getProducts().stream())
                .map(Product::getName)
                .distinct()
                .toList();
        System.out.println("결과 4 : " + answer4);
        ...
        System.out.println("결과 5 : " + answer5);
        ...
        System.out.println("결과 6 : " + answer6);
    }
}
